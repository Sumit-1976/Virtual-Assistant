...
const Customize = () => {
    ...
    return (
        <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px]'>
            <MdKeyboardBackspace onClick={()=>navigate("/")} className='absolute top-[30px] left-[30px] text-white w-[25px] h-[25px] cursor-pointer' />
            ...
            {selectedImage && <button className='min-w-[150px] h-[60px] text-black font-semibold text-[19px] mt-[30px] bg-white rounded-full cursor-pointer' onClick={()=>navigate("/customize2")}>Next</button>}
        </div>
    )
}
